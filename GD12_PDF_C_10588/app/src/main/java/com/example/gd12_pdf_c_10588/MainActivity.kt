package com.example.gd12_pdf_c_10588
...
import com.example.gd12_pdf_c_10588.databinding.ActivityMainBinding
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama: String, umur: String, tlp: String, alamat: String, kampus: String){
        ...
        val file = File(pdfPath, "pdf_10588.pdf")
        ...
        @SuppressLint("UseCompatLoadingForDrawables") val d = getDrawable(R.drawable.app_logo)
